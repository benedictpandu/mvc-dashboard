                        ...
                        <table class="min-w-full divide-y overflow-hidden divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <?php foreach ($data['data'] as $data) : ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200"><?= $data['nama'] ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><?= $data['email'] ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><?= $data['akses'] ?></td>
                                        <td class="py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <a onclick="editModal(<?= $data['id'] ?>)" data-hs-overlay="#modal" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-yellow-400 hover:text-yellow-800 disabled:opacity-50 disabled:pointer-events-none dark:text-yellow-500 dark:hover:text-yellow-400 dark:focus:outline-none dark:focus:ring-1 mx-3 dark:focus:ring-gray-600 cursor-pointer  ">Ubah</a>
                                            <a onclick="confirmModal(<?= $data['id'] ?>)" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-red-600 hover:text-red-800 disabled:opacity-50 disabled:pointer-events-none dark:text-red-500 dark:hover:text-red-400 dark:focus:outline-none dark:focus:ring-1 mx-3 dark:focus:ring-gray-600 cursor-pointer">Hapus</a>
